...
const NavLink: React.FC<{ href: string; children: React.ReactNode }> = ({ href, children }) => (
  <a href={href} className="text-slate-300 hover:text-pink-400 transition-colors duration-300">
    {children}
  </a>
);
...
const Navbar: React.FC = () => {
  ...
  return (
    <>
      <nav className={`fixed top-0 left-0 right-0 z-50 h-20 transition-all duration-500 ${
        scrolled 
        ...
        <div className="relative container mx-auto flex justify-between items-center h-full px-4">
          <a href="#" className="flex items-center gap-2">
            <span className="font-bold text-xl text-white drop-shadow-lg">Connector</span>
          </a>
          ...
          <div className="hidden lg:block">
            <a href="#" className="relative border border-pink-500/60 bg-pink-500/10 text-pink-400 px-5 py-2 rounded-full text-sm font-semibold hover:bg-pink-500 hover:text-black hover:border-pink-500 transition-all duration-300 backdrop-blur-sm shadow-lg shadow-pink-500/20">
              Sign In
            </a>
          </div>
      ...
      >
        ...
        <div className="relative flex flex-col items-center gap-10 text-xl">
          ...
          <NavLink href="#">Pricing</NavLink>
          <NavLink href="#">About</NavLink>
          <a href="#" className="mt-8 border border-pink-500/60 bg-pink-500/10 text-pink-400 px-6 py-2 rounded-full font-semibold hover:bg-pink-500 hover:text-black hover:border-pink-500 transition-all duration-300 ">
            Sign In
          </a>
        </div>
      </div>
